//会议管理
const meetingRoomMage_apply = () => import (/* webpackChunkName: "meetingRoomMage" */ '../../views/kqxz/meetingRoomMage/Apply.vue');
const meetingRoomMage_applylist = () => import (/* webpackChunkName: "meetingRoomMage" */ '../../views/kqxz/meetingRoomMage/ApplyList.vue');
const meetingRoomMage_check = () => import (/* webpackChunkName: "meetingRoomMage" */ '../../views/kqxz/meetingRoomMage/Check.vue');
const meetingRoomMage_detail = () => import (/* webpackChunkName: "meetingRoomMage" */ '../../views/kqxz/meetingRoomMage/Detail.vue');

//请假管理
const leaveMage_apply = () => import(/* webpackChunkName: "leaveMage" */ '../../views/kqxz/leaveMage/Apply.vue')
const leaveMage_applylist = () => import(/* webpackChunkName: "leaveMage" */ '../../views/kqxz/leaveMage/ApplyList.vue')
const leaveMage_check = () => import(/* webpackChunkName: "leaveMage" */ '../../views/kqxz/leaveMage/Check.vue')
const leaveMage_detail = () => import(/* webpackChunkName: "leaveMage" */ '../../views/kqxz/leaveMage/Detail.vue')
const leaveMage_allRecord = () => import(/* webpackChunkName: "leaveMage" */ '../../views/kqxz/leaveMage/AllRecord.vue')

//出差管理
const businesstripMage_apply = () => import(/* webpackChunkName: "businesstripMage" */ '../../views/kqxz/businesstripMage/Apply.vue')
const businesstripMage_applylist = () => import(/* webpackChunkName: "businesstripMage" */ '../../views/kqxz/businesstripMage/ApplyList.vue')
const businesstripMage_check = () => import(/* webpackChunkName: "businesstripMage" */ '../../views/kqxz/businesstripMage/Check.vue')
const businesstripMage_detail = () => import(/* webpackChunkName: "businesstripMage" */ '../../views/kqxz/businesstripMage/Detail.vue')
