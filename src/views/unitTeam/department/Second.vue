...
export default {
  ...
  mounted(){
    //   document.getElementsByClassName('site-path')[0].getElementsByTagName('li')[0].innerHTML = '部门管理';
    //   document.getElementsByClassName('site-path')[0].getElementsByTagName('li')[1].innerHTML = this.name;
    //   document.getElementsByClassName('site-path')[0].getElementsByTagName('li')[2].innerHTML = '二级部门管理';
  ...
  methods:{
      ...
      handleRowClick(v){
          this.$router.push({ name: "departmentMage_third" ,query:{id:v.id,name_1:this.name,name_2:v.dept_name}});
      },      
      // 编辑回填
      fillForm(item){
